...
alpha = 5.0
beta = 1.0
safety_distance = 10    # Safety distance between vehicles (in meters)
inter_conflict_distance = 10  # Distance between conflict points (in meters)
...
pi = [
    ...
    Vehicle(vehicle_id=4, approach="W", maneuver="S", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=5, approach="E", maneuver="L", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=6, approach="N", maneuver="L", priority_status=False, velocity=velocity_range),
    ...
    # Vehicle(vehicle_id=13, approach="N", maneuver="L", priority_status=True, velocity=velocity_range),
    # Vehicle(vehicle_id=14, approach="W", maneuver="S", priority_status=False, velocity=velocity_range),

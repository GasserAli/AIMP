...
pi = [
    ...
    Vehicle(vehicle_id=15, approach="S", maneuver="S", priority_status=True, velocity=velocity_range),
    ...
    Vehicle(vehicle_id=24, approach="E", maneuver="S", priority_status=False, velocity=velocity_range),

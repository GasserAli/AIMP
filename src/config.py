...
velocity_range = (10,20)  # Minimum and maximum velocity for all vehicles
tau = 15.5                # Headway time (in seconds)
alpha = 1.0
beta = 1.0
safety_distance = 4.0    # Safety distance between vehicles (in meters)
inter_conflict_distance = 2.0  # Distance between conflict points (in meters)
...
pi = [
    ...
    Vehicle(vehicle_id=9, approach="N", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=10, approach="S", maneuver="L", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=11, approach="E", maneuver="L", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=12, approach="E", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=13, approach="N", maneuver="L", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=14, approach="W", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=15, approach="N", maneuver="S", priority_status=False, velocity=velocity_range),
    ...
    Vehicle(vehicle_id=20, approach="S", maneuver="L", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=21, approach="E", maneuver="L", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=22, approach="E", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=23, approach="N", maneuver="L", priority_status=False, velocity=velocity_range),
    Vehicle(vehicle_id=24, approach="W", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=25, approach="N", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=26, approach="E", maneuver="R", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=27, approach="S", maneuver="L", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=28, approach="W", maneuver="L", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=29, approach="N", maneuver="S", priority_status=True, velocity=velocity_range),
    Vehicle(vehicle_id=30, approach="S", maneuver="L", priority_status=True, velocity=velocity_range),
]
